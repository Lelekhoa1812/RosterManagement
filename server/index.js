...
app.post('/api/fetch_business_code', (req, res) => {
    ...
    // Dynamically create a connection using the provided business code
    const dbConfig = {
        host: 'localhost',
        user: 'root',
        password: '',
    ...
    const db1Scoped = mysql.createConnection(dbConfig); // Create a new connection for each request
